    ...
    <Dialog>
      ...
      <DialogContent className="max-w-md max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between py-2 border-b">
          <Label htmlFor="shortcuts-toggle" className="text-sm font-medium">Keyboard shortcuts</Label>
          <Switch id="shortcuts-toggle" checked={enabled} onCheckedChange={onToggle} aria-label="Toggle keyboard shortcuts on or off" />
        </div>
